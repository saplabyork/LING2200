...
### 1. Suppose a cochlear implant was inserted into the cochlea (at the base of the stapes into the oval window) of someone with profound hearing loss. There was a mistake when the implant was made and frequencies at the apex of cochlea were not firing. Briefly explain whether this person would hear the difference between a male and female voice. [2pts]
...
What is the RMS amplitude of the resulting wave when the two waves are added? Round your answer to the two digits. [2pts]
...
### 11. Why does the "k" in "coo" sound different from the "k" in "key, and what phenomenon is it the result of? (There are two correct answers, circle both) [2pts]
...
### 13. What is the dB value for a sound with an absolute intensity of 0.0051 $W/m^2$? Round your answer to two decimal places.[3pts]

$$\\[3.5in]$$

### 14. Suppose you have a tube that's closed at one end. The frequency of the 3rd resonance is 0.044kHz. Assuming that the speed of sound is 330m/s, what is the length of the tube in cm? Use correct units.[3pts]
